...
//     Route::get('/admin/agents/{id}', [AgentApprovalController::class, 'show'])->name('admin.agents.show');
    
//     Route::post('/admin/agents/{id}/update-status', [AgentApprovalController::class, 'updateStatus'])->name('admin.agents.update-status');
    
//     Route::post('/admin/agents/{id}/approve', [AgentApprovalController::class, 'approve'])->name('admin.agents.approve');
//     Route::post('/admin/agents/{id}/disable', [AgentApprovalController::class, 'disable'])->name('admin.agents.disable');
//     Route::post('/admin/agents/{id}/enable', [AgentApprovalController::class, 'enable'])->name('admin.agents.enable');
...
Route::middleware(['auth', 'role:super_admin'])->prefix('admin')->group(function () {
    ...
    // Agents
    // Route::resource('agents', AgentApprovalController::class);
    // Route::post('agents/{agent}/approve', [AgentApprovalController::class, 'approve'])->name('agents.approve');

    // View all submissions
    Route::get('submissions', [AdminFormSubmissionController::class, 'index'])->name('admin.submissions');

    // Manage Commissions
    Route::post('submissions/{submission}/mark-paid', [AdminFormSubmissionController::class, 'markPaid'])->name('admin.submissions.markPaid');
});
...
Route::prefix('student')->middleware(['auth', 'role:student'])->group(function () {
    ...
    // Route::get('forms/available', [StudentApplicationController::class, 'availableForms'])
    //     ->name('student.forms.available');

    // Show a single form
    Route::get('forms/{form}/apply', [StudentApplicationController::class, 'apply'])
        ->name('student.forms.apply');

    // Store submitted form
    Route::post('forms/{form}/submit', [StudentApplicationController::class, 'submit'])
        ->name('student.forms.submit');

    // Student submission history
    Route::get('submissions', [StudentApplicationController::class, 'submissions'])
        ->name('student.forms.submissions');
