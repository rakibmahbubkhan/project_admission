    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('super_admin.forms.edit', $form->id) }}" class="btn btn-sm btn-warning">Edit</a>
                    <form action="{{ route('super_admin.forms.destroy', $form->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
