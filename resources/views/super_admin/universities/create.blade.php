                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <div id="logoPlaceholder">
                                ...
                                <span class="block text-xs text-gray-500">Click to upload logo</span>
                            </div>
                            <img id="logoPreview" class="mx-auto h-20 object-contain hidden" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <div id="coverPlaceholder">
                                ...
                                <span class="block text-xs text-gray-500">Click to upload cover</span>
                            </div>
                            <img id="coverPreview" class="mx-auto h-24 object-cover rounded hidden" />
                        </div>
